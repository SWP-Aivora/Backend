...
public interface IService
{
    ...
    Task<Aivora.Services.Base.Response.PageResult<Response.ReviewResponse>> GetProjectReviewsAsync(Guid projectId, Aivora.Services.Base.Request.PageRequest pageRequest);
}
