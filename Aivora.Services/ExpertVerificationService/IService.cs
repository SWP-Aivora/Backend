...
public interface IService
{
    ...
    Task<Base.Response.PageResult<Response.ExpertVerificationResponse>> GetAdminVerificationsAsync(Base.Request.PageRequest pageRequest, ExpertVerificationStatus? status, Guid? expertId, string? search = null);
