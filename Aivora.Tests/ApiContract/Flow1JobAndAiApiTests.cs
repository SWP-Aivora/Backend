...
public class Flow1JobAndAiApiTests : IClassFixture<ApiContractTestFactory>
{
    ...
    public async Task Run_Flow1_API_Verification_Sequence()
    {
        ...
        var patchReq = new { suggestedTitle = "AI Enhanced: Build a recommendation engine", experienceLevel = "EXPERT" };
        ...
        // 1.7 POST /api/v1/ai/service-generator (Expert role)
        ...
        var updateJobReq = new { title = "Manual Job Post - Updated", budgetMin = 1200 };
